...
VMS_2_split <- VMS_2_split[VMS_2_indices] 

VMS_3_split <- VMS_3_split[VMS_3_indices] 
...
VMS_1_interp <- interpolate_list(VMS_1_split, 10)
VMS_2_interp <- interpolate_list(VMS_2_split, 10)
VMS_3_interp <- interpolate_list(VMS_3_split, 10)
